...
<input type="hidden" name=gr value="{GR}" >
      ...
      <table border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="500" id="AutoNumber4" height="38">
        <tr>
          ...
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="P1_SCORE" size="20" value="{P1_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;P2_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="P2_SCORE" size="20" value="{P2_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;P3_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="P3_SCORE" size="20" value="{P3_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;P4_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="P4_SCORE" size="20" value="{P4_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;P5_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="P5_SCORE" size="20" value="{P5_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;P6_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="P6_SCORE" size="20" value="{P6_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;E1_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="E1_SCORE" size="20" value="{E1_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;E2_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="E2_SCORE" size="20" value="{E2_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;E3_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="E3_SCORE" size="20" value="{E3_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;E4_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="E4_SCORE" size="20" value="{E4_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;E5_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="E5_SCORE" size="20" value="{E5_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;E6_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="E6_SCORE" size="20" value="{E6_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;E7_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="E7_SCORE" size="20" value="{E7_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;E8_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="E8_SCORE" size="20" value="{E8_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;E9_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="E9_SCORE" size="20" value="{E9_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;A1_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="A1_SCORE" size="20" value="{A1_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;A2_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="A2_SCORE" size="20" value="{A2_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;A3_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="A3_SCORE" size="20" value="{A3_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R1_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R1_SCORE" size="20" value="{R1_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R2_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R2_SCORE" size="20" value="{R2_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R3_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R3_SCORE" size="20" value="{R3_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R4_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R4_SCORE" size="20" value="{R4_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R5_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R5_SCORE" size="20" value="{R5_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R6_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R6_SCORE" size="20" value="{R6_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R7_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R7_SCORE" size="20" value="{R7_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R8_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R8_SCORE" size="20" value="{R8_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R9_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R9_SCORE" size="20" value="{R9_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R10_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R10_SCORE" size="20" value="{R10_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R11_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R11_SCORE" size="20" value="{R11_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;R12_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="R12_SCORE" size="20" value="{R12_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;L1_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="L1_SCORE" size="20" value="{L1_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;L2_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="L2_SCORE" size="20" value="{L2_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;L3_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="L3_SCORE" size="20" value="{L3_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S1_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S1_SCORE" size="20" value="{S1_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S2_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S2_SCORE" size="20" value="{S2_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S3_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S3_SCORE" size="20" value="{S3_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S4_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S4_SCORE" size="20" value="{S4_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S5_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S5_SCORE" size="20" value="{S5_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S6_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S6_SCORE" size="20" value="{S6_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S7_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S7_SCORE" size="20" value="{S7_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S8_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S8_SCORE" size="20" value="{S8_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S9_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S9_SCORE" size="20" value="{S9_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S10_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S10_SCORE" size="20" value="{S10_SCORE}" ></td> 
        </tr><tr>
          <td width="145" height="19" bgcolor="#CCFFCC">
          <font face="MS Sans Serif" size="2">&nbsp;S11_SCORE</font></td>
          <td width="352" height="19" bgcolor="#CCFFCC">         
          <input type="text" name="S11_SCORE" size="20" value="{S11_SCORE}" ></td> 
        </tr><tr>
