...
/***************************************************************************
 *
 *   แปลงเป็นไทยโดย thainuke(webmaster@thainuke.net)
 *   PHP-Nuke Thailand community and support web site :: http://www.thainuke.net
 *
 ***************************************************************************/
...
if(!$db->db_connect_id) {
    die("<br><br><center><img src=images/logo.gif><br><br><b>มีปัญหาเกิดขึ้นกับฐานข้อมูล ขออภัยในความไม่สะดวก<br><br>ทางเรากำลังทำการปรับปรุงแก้ไข เพื่อให้สามารถใช้งานได้ในไม่ช้า</center></b>");
}
