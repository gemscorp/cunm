...
<table id='report' class='table table-striped table-bordered'>
		...
		{foreach from=$users item=user}
			<tr>
				...
				<td><a href="/admin/user/password/{$user.id}">Change Password</a></td>
				<td><a href="/admin/user/delete/{$user.id}" onclick="return confirm('do you want to delete the user?');">Delete</a></td>
			</tr>
		{/foreach}
		</tbody>
	</table>
